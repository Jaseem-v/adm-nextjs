    ...
    {/* \\\\\\\\\\\\ */}
      ...
      <section className="bg-black -mt-20">
        <div className="text-white  pb-10 md:pb-12 xl:pb-20 pt-16 md:pt-20 xl:pt-32 text-left">
          ...
          <p className="font-semibold font-poppins text-xl tracking-wide">OUR MISSION</p>
          <h3 className="font-semibold text-4xl font-poppins text-[#FFF5CF] max-w-[890px] mt-5 leading-[1.3]">Our mission is to empower businesses with technology, helping them to reach their full potential and achieve their goals.</h3>
          </div>
          <div className="w-full mt-16">
          <img src="/images/path.png" alt="path" className="w-screen" />
        </div>
        <div className="mt-16 max-w-screen-xl mx-auto px-5 xl:px-0 flex items-start gap-20">
          <p className="font-poppins font-medium text-xl leading-8 flex-1">Our mission is centered around facilitating the growth and success of businesses by providing a dynamic platform for collaboration, learning, and support. We foster a vibrant community where entrepreneurs, professionals, and business owners can connect, exchange ideas, and gain valuable insights.
</p>
          <div className="flex flex-col gap-6 flex-1">
            <p className="font-poppins font-medium text-xl leading-8 ">Through our network and resources, we aim to empower businesses to reach their full potential, realize their goals, and stay ahead in an ever-evolving marketplace.
            </p>
