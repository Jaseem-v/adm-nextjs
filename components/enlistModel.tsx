  ...
  return (
    ...
    >
      <div className="relative flex flex-col  md:flex-row gap-5 p-5 text-center font-lexend font-medium text-2xl lg:text-3xl bg-black rounded-lg z-50 ">
        <div className="enlist-company md:pb-14 w-64 h-48 md:w-56 md:h-[400px] lg:w-64 lg:h-[460px] flex  items-center md:items-end justify-center hover:cursor-pointer rounded-sm hover:border hover:border-white ">
          <h2 className="hover:underline hover:underline-offset-1 transition-all duration-300">
            Enlist <br />
            Company
          </h2>
        </div>
        <div className="enlist-individual md:pb-14 w-64 h-48 md:w-56 md:h-[400px] lg:w-64 lg:h-[460px] flex items-center md:items-end justify-center hover:cursor-pointer rounded-sm hover:border hover:border-white relative">
