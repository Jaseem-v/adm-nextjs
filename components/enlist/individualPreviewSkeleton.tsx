...
export const IndividualPreviewSkeleton = ({
  firstname,
  lastname,
  place,
  phone,
  ...
  return (
    <div className="w-full">
      ...
      <div className="bg-skeleton flex justify-between items-center p-3 flex-wrap font-inter">
        <div className="flex items-center">
          ...
          <div className="rounded-lg rounded-r-none bg-white flex items-center p-2">
            ...
            <div className="flex items-center gap-1">
              <CiLocationOn />
              <p className="font-regular">{place && place.length > 0 ? place : "Place"}</p>
            </div>
          </div>
        ...
        <div className="bg-darkSkeleton py-2 px-3 rounded text-white text-sm">Sign up</div>
      </div>
      ...
      <div className="bg-white py-4">
        <div className="px-8">
          ...
          <div className="flex items-center text-darkSkeleton font-bold">
            <p className="py-3 border-b-4 border-darkSkeleton">Overview</p>
          ...
          <div className="flex justify-between">
            <div className="flex gap-1 items-baseline">
              ...
              <div className="flex flex-col">
                ...
                <p>{place && place.length > 0 ? place : "Place"}</p>
              </div>
            </div>
